...
export class interfaz
{
    ...
    constructor(nombre,img,destino,reply="none")
    {
        this.crearVariables()
        this._usoDeLaInterfaz(reply)
        this.setnombre(nombre)
        this.agregarEstilos(img)
        this.introducirFragment(destino)
    ...
    {   
        ...
        //Agregar imagen
        this.userImgSend.src=img;           
        //Agregar imagen

    }

    introducirFragment(destino)
    {
        ...
        destino.appendChild(this.Contenedor); 
    }
    _usoDeLaInterfaz(uso){
        this.usoDeLaInterfaz = uso
    }
    setnombre(nombre){
        this.nombre=nombre
    }
    ...
    agregarEventListener()
    {
        if(this.usoDeLaInterfaz == "none")
        {
            this.sendButton.addEventListener("click",()=>
            {
                ...
                new Comentario(this.nombre,this.userImgSend.src,root,this.emisorMensaje.value,"comment")
        ...
        else
        {
            this.sendButton.addEventListener("click",(event)=>
            {
                ...
                else
                {
                    ...
                    new Comentario(this.nombre,this.userImgSend.src,this.emisorMensaje.value,"unaffiliated")
...
export class Comentario
{
    ...
    constructor(nombre,img,destino,content,type)
    {
        Comentario.id++;
